...
class PT_Search {
	...
	public static function register() {
		add_shortcode( 'pt-search', array( __CLASS__, 'render_form' ) );
		add_shortcode( 'pt-search-results', array( __CLASS__, 'render_results' ) );
	}
